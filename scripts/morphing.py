...
from yukarin_wavernn.config import create_from_json as create_config
from yukarin_wavernn.generator import Generator, MorphingPolicy, SamplingPolicy
from yukarin_wavernn.utility.json_utility import save_arguments
